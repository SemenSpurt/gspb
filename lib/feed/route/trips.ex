  ...
  weekday =
    ...
    query =
      from trip in Trip,
        ...
        left_join: s_id in subquery(schedule),
        on: s_id.service_id == trip.service_id,
        left_join: e_id in subquery(exceptions),
        on: e_id.service_id == trip.service_id,
        where: e_id.exception_type != 2
